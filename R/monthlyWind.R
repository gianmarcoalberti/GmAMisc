...
#' @param lon1: western longitude. If it is set to NULL (default), it is derived from either the raster or the country parameter.
#' @param lon2: eastern longitude. If it is set to NULL (default), it is derived from either the raster or the country parameter.
#' @param lat1: southern latitude. If it is set to NULL (default), it is derived from either the raster or the country parameter.
#' @param lat2: northern latitude. If it is set to NULL (default), it is derived from either the raster or the country parameter.
#' @keywords wind
#' @export
#' @examples
